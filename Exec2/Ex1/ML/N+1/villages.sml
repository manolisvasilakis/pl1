...
|	repetition (rank, parent, stream, teams, iterations) =
	let
		val i = next_int stream
		val j = next_int stream
...
fun villages file =
	...
	(* make the parent and rank array, +1 so i can access the last element *)
		val parent = Array.tabulate (N+1, fn i => i)
		val rank = Array.array (N+1, 1)
